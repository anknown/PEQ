...
class Base_DB
{
	...
	*/
    ...
    public function ralConnect($strName)
    {
        ...
        $this->setConnectTimeOut($server['ctimeout'] / 1000.0);
        $this->setWriteTimeOut($server['wtimeout'] / 1000.0);
        $this->setReadTimeOut($server['rtimeout'] / 1000.0);
    
    	$this->isConnected = $this->mysql->real_connect(
    			$this->dbConf['host'],$this->dbConf['uname'],$this->dbConf['passwd'],$this->dbConf['dbname'],$this->dbConf['port'],NULL,$this->dbConf['flags']);
